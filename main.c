...
int main(void) {
    ...
    //Karatsuba vs all {2, 4, 8, 12, 16, 24, 32}
    //Toom3 vs all {48, 64, 81, 96, 128, 162, 192, 243, 256}
    //Toom4 vs all {256, 300, 384, 512, 768, 1024, 1536, 2048, 3072, 4096}
    int size_of_polynomials[] = {256, 300, 384, 512, 768, 1024, 1536, 2048, 3072, 4096, 4448, 5120};
    ...
    for (int i = 0; i < amount_of_sizes; i++) {
        for (int sample = 0; sample < SAMPLE_SIZE; sample++) {
            ...
            double *result4 = calloc(max_size * 2, sizeof(double));
            ...
            status = tom4(a4, b4, max_size, result4);
